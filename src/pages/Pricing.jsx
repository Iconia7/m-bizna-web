...
if (!token) {
  ...
  return (
    <div className="pt-20">
        <SEO 
  title="Pricing Packages | Affordable Web & App Development"
  description="Transparent pricing for web design and software development in Kenya. Choose a package that fits your budget and business goals."
  url="/pricing"
/>
